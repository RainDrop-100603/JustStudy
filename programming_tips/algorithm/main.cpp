...
int main(){
  ...
  for(auto& ele:tmp1){cout<<ele<<" ";}cout<<endl;
  for(auto& ele:tmp2){cout<<ele<<" ";}cout<<endl;
  for(auto& ele:tmp3){cout<<ele<<" ";}cout<<endl;
  for(auto& ele:tmp4){cout<<ele<<" ";}cout<<endl;
  for(auto& ele:tmp5){cout<<ele<<" ";}cout<<endl;
  for(auto& ele:tmp6){cout<<ele<<" ";}cout<<endl;
  return 0;
}
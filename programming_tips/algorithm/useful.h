...
//"에라스토테네스의 채"와 bitmask를 이용한 prime 구하기 
  // num까지의 숫자들의 소수 여부를 구하고 싶다면, 에라스토테세의 채를 먼저 구한 후, isPrime(num,eratosthenes)함수를 이용한다.
  // 소수를 단 한번만 구하면 된다면, isPrime(num)을 이용한다. (자동으로 eratosthenes를 구해준다.). 여러개의 소수를 확인할 때는 비효율적이다.

...
//       O(m^2)
//     보완 & 참고
//       수학적 해법: 기대확률 R(현재확률 = R-1), 현재 승수 w, 현재 판수 p, 추가 승수 x
//         100(x+w)/(p+x)>=R, x>=(Rp-100w)/(100-R), 만족하는 x를 올림하면 된다.
//   */
//   //Sol
//   int testCase;
//   cin>>testCase;
...
//       determine3: not-nerd가 위에 있는 경우를 보완해준다. 개선 여지 있어보임
//   */
//   //Sol
//   int testCase;
//   cin>>testCase;
